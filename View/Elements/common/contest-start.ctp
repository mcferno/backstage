	...
	<div class="modal-body">
		<div class="assets form">
			<fieldset>
				...
				<?= $this->Form->input('message', array('type' => 'textarea', 'label' => false, 'class' => 'asset-url form-control', 'placeholder' => 'Who can do the best caption with this?', 'spellcheck' => 'true')); ?>
