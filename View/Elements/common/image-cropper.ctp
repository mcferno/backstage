...
<div class="crop-actions" style="display: none;">
	...
	<button class="btn btn-large btn-primary crop-save"><span class="glyphicon glyphicon-download"></span> Save Cropped Image</button>
	<button class="btn btn-large btn crop-cancel"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
</div>