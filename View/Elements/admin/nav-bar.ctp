		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<li <?php if($this->request->controller == 'pages' && $this->request->action == 'admin_group_chat') { echo 'class="active"'; } ?>><?= $this->Html->link('<i class="icon-list icon-white"></i> Group Chat ',array('controller'=>'pages','action'=>'group_chat'),array('escape'=>false,'class'=>'chat-link')); ?></li>
