		...
		<ul class="nav navbar-nav">
			...
			<li <?= $imageSectionIsActive ? 'class="active dropdown"' : 'class="dropdown"'; ?>>
				...
				<ul class="dropdown-menu">
					...
					<li><?= $this->Html->link('<span class="glyphicon-text-width glyphicon"></span> <span>Meme Templates</span>', array('controller' => 'assets', 'action' => 'users', 'type' => 'Meme-Templates'), array('escape' => false, 'title' => 'Images without any text')); ?></li>
					<li><?= $this->Html->link('<span class="glyphicon-th glyphicon"></span> <span>All User Images</span>', array('controller' => 'assets', 'action' => 'admin_users'), array('escape' => false, 'title' => 'Images from all users')); ?></li>
					<li><?= $this->Html->link('<span class="glyphicon-th-large glyphicon"></span> <span>All Memes</span>', array('controller' => 'assets', 'action' => 'users', 'type' => 'Meme'), array('escape' => false, 'title' => 'Images with text already applied')); ?></li>
					<?php if($showIncompleteSections) : ?>
					<li><?= $this->Html->link('<span class="glyphicon-fire glyphicon"></span> <span>Caption Battles</span>', array('controller' => 'contests', 'action' => 'index'), array('escape' => false)); ?></li>
					<?php endif; ?>
					...
					<li><?= $this->Html->link('<span class="glyphicon-book glyphicon"></span> <span>All User Albums</span>', array('controller' => 'assets', 'action' => 'albums'), array('escape' => false)); ?></li>
			...
			<li <?= $appsSectionIsActive ? 'class="active dropdown"' : 'class="dropdown"'; ?>>
				...
				<ul class="dropdown-menu">
					<li><?= $this->Html->link('<span class="glyphicon-fire glyphicon"></span> <span>Caption Battles</span>', array('controller' => 'contests', 'action' => 'index'), array('escape' => false)); ?></li>
					<li><?= $this->Html->link('<span class="glyphicon-star glyphicon"></span> <span>Links</span>', array('controller' => 'links', 'action' => 'index'), array('escape' => false)); ?></li>
				</ul>
			</li>
			...
			<li class="dropdown <?= $otherSectionIsActive ? 'active' : ''; ?>">
				...
				<ul class="dropdown-menu">
					<li><?= $this->Html->link('<span class="glyphicon-star glyphicon"></span> <span>Links</span>', array('controller' => 'links', 'action' => 'index'), array('escape' => false)); ?></li>
					<li><?= $this->Html->link('<span class="glyphicon-comment glyphicon"></span> <span>Quotes</span>', array('controller' => 'posts', 'action' => 'index'), array('escape' => false)); ?></li>
					<li><?= $this->Html->link('<span class="glyphicon-facetime-video glyphicon"></span> <span>Videos</span>', array('controller' => 'videos', 'action' => 'index'), array('escape' => false)); ?></li>
				</ul>
			</li>
			<?php endif; ?>
