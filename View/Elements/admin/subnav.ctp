		...
		if($this->Session->check('Auth.User')) {
			switch(true) {
				...
				?>
					...
					<li <?php if($is_other_albums) { echo 'class="active"'; } ?>><?= $this->Html->link('<span class="glyphicon-camera glyphicon"></span> <strong> All Albums</strong>',array('controller' => 'assets', 'action' => 'albums'),array('escape' => false)); ?></li>

					<li class="nav-header">Images</li>

					<li <?php if($is_personal_assets) { echo 'class="active"'; } ?>><?= $this->Html->link('<span class="glyphicon-home glyphicon"></span> <strong>My Images</strong>',array('controller' => 'assets', 'action' => 'index'),array('escape' => false)); ?></li>
