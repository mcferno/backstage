	...
	<div class="col-md-12">
		...
		<?php
			...
			if($image) {
				...
				echo $this->Html->link('<span class="glyphicon glyphicon-chevron-left"></span> Return to Video', array('action' => 'view', $video['Video']['id']), array('class' => 'btn btn-default', 'escape' => false));
			} else {
