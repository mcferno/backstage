...
<?php echo $this->Form->create('Tumblr');?>
	<fieldset>
		<legend><?php echo __('Edit Tumblr'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Tumblr.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Tumblr.id'))); ?></li>
