...
Router::connect("{$admin_url}/assets/:action/*", array('controller' => 'assets', 'action' => 'find', 'admin' => true), array('action' => '(find|save)'));
Router::connect("{$admin_url}/users/heartbeat/*", array('controller' => 'users', 'action' => 'heartbeat', 'admin' => true));
Router::connect("{$admin_url}/messages/add/*", array('controller' => 'messages', 'action' => 'add', 'admin' => true));
Router::connect("{$admin_url}/tags/:action/*", array('controller' => 'tags', 'admin' => true), array('action' => '(update|list|add_tags)'));
